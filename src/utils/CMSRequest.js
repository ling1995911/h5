...
export default {
  async get (params, _event) {
    try {
      ...
      console.log('--------')
      console.log(cookie.get(APP_TOKEN_KEY))
      let result = await Request.get(params, cookie.get(APP_TOKEN_KEY))
  ...
  async post (params, _event) {
    try {
      ...
      let result = await Request.post(params, cookie.get(APP_TOKEN_KEY))
      return handle(result)
    } catch (err) {
      return Promise.reject(err)
    }
  ...
  async put (params, _event) {
    try {
      ...
      let result = await Request.put(params, cookie.get(APP_TOKEN_KEY))
      return handle(result)
    } catch (err) {
      return Promise.reject(err)
    }
  ...
  async patch (params, _event) {
    try {
      ...
      let result = await Request.patch(params, cookie.get(APP_TOKEN_KEY))
      return handle(result)
    } catch (err) {
      return Promise.reject(err)
    }
